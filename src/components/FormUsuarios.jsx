...
//                         console.log("Rol ID convertido a string:", rolId);
//                         setRol(rolId);
...
//                 setSector('');
//                 setLegajo('');
//                 setRol('');    // O el valor por defecto que uses
//                 setActivo(false); // O true, según tu lógica
//             }
...
//                 className="w-full max-w-lg bg-[#1f1f1f] rounded-xl shadow-lg p-8 space-y-5 border border-orange-400"
//             >

//                 <h2 className="text-3xl font-semibold mb-8 text-orange-400 text-center">{usuario_id ? "Editar Usuario" : "Agregar Usuario"}</h2>
//                 <input
//                     type="text"
//                     placeholder="Nombre"
//                     value={nombre}
...
//                 <input
//                     type="submit"
//                     value={usuario_id ? "Actualizar" : "Agregar"}
...
//             <a
//                 href="http://localhost:5173/adminusuario"
//                 className="mt-6 text-sm text-orange-300 hover:text-orange-500 transition"
//             >
//                 ⬅ Volver
//             </a>
//         </div>
...
//             <a href="http://localhost:5173/adminusuario"
//                 className="mt-6 text-sm text-orange-300 hover:text-orange-500 transition">
//                 ⬅ Volver
//             </a>
//         </div>
