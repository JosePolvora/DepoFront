...
//   return (
//     <div className="bg-zinc-900 min-h-screen flex justify-center items-start p-6">
//       <div className="bg-zinc-800 rounded-lg border-2 border-orange-500 p-8 shadow-md w-full max-w-5xl">
//         <h2 className="text-2xl font-bold text-center text-orange-500 mb-6">Pregúntas Frecuentes</h2>

//         {/* Preguntas frecuentes en fila horizontal */}
//         <div className="mb-6">
//           <h3 className="text-lg text-yellow-200 mb-2">Preguntas:</h3>
//           <div className="flex overflow-x-auto space-x-4 pb-2">
//             {preguntasFrecuentes.map((pregunta, index) => (
//               <button
//                 key={index}
//                 onClick={() => consultarPregunta(pregunta)}
//                 className="whitespace-nowrap bg-orange-600 hover:bg-orange-700 text-black font-semibold px-4 py-2 rounded-md text-sm flex-shrink-0"
//               >
//                 {pregunta}
//               </button>
//             ))}
...
//           <div>
//             <label htmlFor="gemini-question" className="block text-sm font-medium mb-1 text-yellow-200">Tu pregunta:</label>
//             <textarea
//               id="gemini-question"
