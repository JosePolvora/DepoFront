...
//     // Texto JSON que incluirá número de plano y denominación
...
//             </h1>
//             <h2 className="text-lg mb-6 text-gray-300">Denominación: {denominacion}</h2>

//             <div className="bg-zinc-800 p-6 rounded-lg shadow-lg border-2 border-orange-500">
//                 <QRCodeCanvas
//                     value={qrValue}
//                     size={256}
//                     bgColor="#ffffff"
...
//                     includeMargin={true}
//                 />
//                 <p className="text-center mt-4 text-sm text-gray-400 max-w-xs whitespace-pre-wrap">
