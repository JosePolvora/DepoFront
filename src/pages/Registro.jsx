      ...
      <div className="relative z-10 bg-zinc-800 border-2 border-orange-500 p-8 rounded-lg shadow-xl max-w-2xl w-full">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex flex-col md:flex-row md:space-x-4 space-y-4 md:space-y-0">
            <div className="w-full md:w-1/2">
              <label htmlFor="nombre" className="block text-sm font-semibold text-yellow-200 mb-1">
                Nombres
              </label>
              <input
                type="text"
            ...
            <div className="w-full md:w-1/2">
              <label htmlFor="apellido" className="block text-sm font-semibold text-yellow-200 mb-1">
                Apellido
              </label>
              <input
                type="text"
          ...
          <div className="flex flex-col md:flex-row md:space-x-4 space-y-4 md:space-y-0">
            <div className="w-full md:w-1/2">
              <label htmlFor="sector" className="block text-sm font-semibold text-yellow-200 mb-1">
                Sector
              </label>
              <input
                type="text"
            ...
            <div className="w-full md:w-1/2">
              <label htmlFor="legajo" className="block text-sm font-semibold text-yellow-200 mb-1">
                Legajo
              </label>
              <input
                type="text"
